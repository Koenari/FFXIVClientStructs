...
public unsafe partial struct Framework {
    ...
    [Obsolete] [FieldOffset(0x09FC)] public int CursorPosX;
    [Obsolete] [FieldOffset(0x0A00)] public int CursorPosY;
    ...
    [Obsolete] [FieldOffset(0x110C)] public int CursorPosX2;
    [Obsolete] [FieldOffset(0x1110)] public int CursorPosY2;
